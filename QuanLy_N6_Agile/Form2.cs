...
namespace QuanLy_N6_Agile
{
    public partial class Form2 : Form
    {
        ...
        public void LoadData()
        {
            ...
            dgv_ThongTin.DataSource = resul.OrderBy(x => x.Masv).ToList();

            dgv_ThongTin.Columns[0].HeaderText = "ID Sinh Viên";
            dgv_ThongTin.Columns[1].HeaderText = "Mã Sinh Viên";
            dgv_ThongTin.Columns[2].HeaderText = "Họ Tên";
            dgv_ThongTin.Columns[3].HeaderText = "Điểm Tiếng Anh";
            dgv_ThongTin.Columns[4].HeaderText = "Điểm Tin Học";
            dgv_ThongTin.Columns[5].HeaderText = "Điểm GDCD";
            dgv_ThongTin.Columns[6].HeaderText = "Điểm Trung Bình";
        ...
        private void btn_TimKiem_Click(object sender, EventArgs e)
        {
            ...
            Grade grade = db.Grades.Find(studentId);
            if (grade != null)
            {
                txt_MaSv.Text = grade.Masv;
                txtTiengAnh.Text = grade.Tienganh.ToString();
                txtTinHoc.Text = grade.Tinhoc.ToString();
                txtGDTC.Text = grade.Gdtc.ToString();
            }
            else
            {
        ...
        {
            int d = e.RowIndex;
            txt_ID.Text = dgv_ThongTin.Rows[d].Cells[0].Value.ToString();
            txt_MaSv.Text = dgv_ThongTin.Rows[d].Cells[1].Value.ToString();
            txtTen.Text = dgv_ThongTin.Rows[d].Cells[2].Value.ToString();
            txtTiengAnh.Text = dgv_ThongTin.Rows[d].Cells[3].Value.ToString();
            txtTinHoc.Text = dgv_ThongTin.Rows[d].Cells[4].Value.ToString();
            txtGDTC.Text = dgv_ThongTin.Rows[d].Cells[5].Value.ToString();
            ...
            try
            {
               ...
               if (string.IsNullOrWhiteSpace(txtTiengAnh.Text))
                ...
                else
                {
                    ...
                    int idSvSua = Convert.ToInt32(txt_ID.Text);
